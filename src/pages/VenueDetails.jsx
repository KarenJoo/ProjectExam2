...
const VenueDetails = () => {
  ...
  const { name, description, media, price, maxGuests, meta, location, rating, owner, bookings } = venueDetails;
    ...
    <Card className={styles.venueCard} style={{ backgroundColor: '#fff' }}>
      ...
      <CardContent>
        ...
        <Typography variant='body2'>
          Address: {location.address}, {location.city}, {location.country} | Max Guests: {maxGuests}
        </Typography>
        <Typography variant='body2'>
          Rating: {rating}
        </Typography>
